    ...
    group-hover:opacity-100 transition-all duration-500"
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {!cartItem ? (
          <motion.button
            whileTap={{ scale: 0.96 }}
            className="mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700
        text-white rounded-full py-2 text-sm font-medium transition-all"
          ...
          <motion.div
            ...
            className="mt-4 flex items-center justify-center bg-green-50 border border-green-200 rounded-full
              py-2 px-4 gap-4"
          >
            <button
