  ...
  flex flex-col p-6 text-white"
          >
            <div className="flex justify-between items-center mb-2 gap-4">
              ...
              <button
                className="text-white hover:text-red-400 text-2xl font-bold transition cursor-pointer"
            ...
            <div
              className="flex items-center gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:white/15
            transition-all shadow-inner"
            >
              <div
                className="relative w-12 h-12 flex justify-center items-center rounded-full overflow-hidden border-2 border-green-400/60
              shadow-lg"
              >
                {user.image ? (
                  <Image
              ...
              <div>
                ...
                <p className="text-xs text-gren-200 capitalize tracking-wide">
                  {user.role}
                </p>
              </div>
            </div>
...
transition-all"
  ...
  return (
    ...
    to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between
     items-center h-20 px-4 md:px-8 z-50 "
    >
      <Link
        href={"/"}
  ...
  hover:scale-105 transition md:hidden"
          ...
          flex items-center justify-center rounded-full font-semibold shadow"
              >
                {cartData.length}
              </span>
            </Link>
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="absolute right-0 mt-3 w-56 bg-white rounded-2xl
         shadow-xl border-gray-200 p-3 z-999"
              >
          ...
          <AnimatePresence>
            {searchBarOpen && (
              <motion.div
                ...
                className="fixed top-24 left-1/2 -translate-x-1/2 w-[90%] bg-white rounded-full shadow-lg 
