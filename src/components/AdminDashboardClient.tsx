  ...
  return (
    <div className="pt-28 w-[90%] md:w-[80%] mx-auto">
      ...
      >
        ...
        <select
          className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2
focus:ring-green-500 outline-none transition w-full sm:w-auto"
      ...
      >
        ...
        <p className="text-4xl font-extrabold text-green-800">
          RS.{currentEarning.toLocaleString()}
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {stats.map((s, i) => {
          const icons = [
            ...
            <Banknote key="r" className="text-green-700 w-6 h-6" />,
          ];
          return (
            <motion.div
              key={i}
    ...
    gap-4 hover:shadow-lg transition-all"
            >
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800t">{s.value}</p>
              </div>
            </motion.div>
          );
        })}
