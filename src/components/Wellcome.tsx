...
function Wellcome({nextStep}:propType) {
  return (
   ...
   your one-step destination for frsh groceries, organic produce, and 
   daily essentials delivered right to your doorstep.
    ...
    font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-10 cursor-pointer'
    onClick={()=> nextStep(2)}>
    Next
    <ArrowRight/>
    </motion.button>
