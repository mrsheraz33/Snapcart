...
function HeroSection() {
  const slides = [
    {
      ...
      title: "Fresh & Organic 🥦",
      subtitle: "100% natural items directly from trusted local farms.",
      btnText: "Shop Now",
    ...
    },
    {
      ...
      subtitle: "Get your daily groceries delivered within 30 minutes.",
      btnText: "Order Now",
    ...
    },
    {
      ...
      subtitle: "Track live orders & get exclusive app-only discounts.",
      btnText: "Get Started",
      bg: "https://plus.unsplash.com/premium_photo-1742244062558-24dd499c6980?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
  ...
  return (
    <div className="relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="absolute bottom-6 -translate-x-1/2 left-1/2 flex gap-3">
        {slides.map((_, index) => (
          <button
            key={index}
