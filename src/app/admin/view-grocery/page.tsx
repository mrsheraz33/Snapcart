  ...
  return (
    <div className="pt-4 w-[95%] md:w-[85%] mx-auto pb-20">
      ...
      >
        ...
        text-green-700 font-semibold px-4 py-2 rounded-full transition-all w-full sm:w-auto "
          onClick={() => router.push("/")}
        >
          <ArrowLeft size={18} />
          Back
        </button>
        <h1 className="text-2xl md:text-3xl font-extrabold text-green-700 flex gap-2 items-center">
      ...
      onSubmit={handelSearch}
        ...
        className="flex items-center bg-white border-gray-200 rounded-full px-5 py-3 shadow-sm
   ...
   sm:flex-row items-center sm:items-start gap-5 p-5 transition-all"
          >
            <div
              className="relative w-full sm:w-44 aspect-square rounded-xl 
overflow-hidden border border-gray-200"
            ...
            <div className="flex-1 flex flex-col justify-between w-full">
              ...
              >
                ...
                <button
                  className="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold flex items-center
        ...
        backdrop-blur-sm px-4"
          >
            ...
            >
              ...
              <div
                className="relative aspect-square w-full rounded-lg overflow-hidden mb-4 border border-gray-200
                group"
              >
                {imagePreview && (
                  <Image
...
focus:ring-2 focus:ring-green-500 outline-none"
                ...
                <select
                  className="w-full border border-gray-300 rounded-lg p-2.5
focus:ring-2 focus:ring-green-500 outline-none bg-white"
...
focus:ring-2 focus:ring-green-500 outline-none bg-white"
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button
                  className="px-4 py-2 rounded-lg bg-green-600 text-white flex items-center gap-2 hover:bg-green-700
                  transition-all"
                  onClick={handelEdit}
                  disabled={loading}
                >
