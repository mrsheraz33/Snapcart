...
function CartPage() {
  ...
  return (
    <div className="w-[95%] sm:w-[90%] md:w-[80%] mx-auto mt-8 mb-24 relative">
      <Link
        href={"/"}
        className="absolute -top-2 left-0 flex items-center gap-2 text-green-700 hover:text-green-800
...
transition-all inline-block font-medium"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         hover:shadow-xl transition-all duration-300 border border-gray-100 "
                  >
                    <div
                      className="relative w-28 h-28 sm:w-24 sm:h-24 md:w-28 md:h-28 flex-shrink-0 rounded-xl overflow-hidden
    bg-gray-50"
                    >
                      <Image
                        src={item.image}
                    ...
                    <div className="mb-4 sm:mt-0 sm:ml-4 flex-1 text-center sm:text-left">
